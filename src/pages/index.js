...
export default function Home() {
  ...
  <GoogleTagManagerNoScript />
    ...
    <main className="flex  min-h-screen flex-col items-center justify-between lg:p-24 pt-20 pl-8 ">
      ...
      <div id='functions' className='rounded-md  flex flex-col  text-center gap-4 text-lg w-fit backdrop-blur-md bg-white/30 p-8 shadow-md shadow-white-400  border-gray-500'>
...
<div className=' flex flex-wrap flex-grow  gap-4 sm:text-sm text-left w-full '>  
